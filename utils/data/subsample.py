...
class MaskFunc:
    ...
    def sample_mask(
        ...
        """
        num_cols = shape[-2]
        center_fraction, acceleration, offset = self.choose_acceleration()
    ...
    def choose_acceleration(self):
        ...
        if self.allow_any_combination:
            ...
            center_fractions = self.rng.choice(self.center_fractions)

        else:
            choice = self.rng.randint(len(self.center_fractions))
            acceleration = self.accelerations[choice]
            center_fractions = self.center_fractions[choice]
        ...
        return center_fractions, acceleration, offset
...
class MagicMaskFractionFunc(MagicMaskFunc):
    ...
    def sample_mask(
        ...
        """
        num_cols = shape[-2]
        fraction_low_freqs, acceleration, offset = self.choose_acceleration()
        num_cols = shape[-2]
...
def create_mask_for_mask_type(
    ...
    if mask_type_str == "random":
        ...
        return EquiSpacedMaskFunc(center_fractions, accelerations, offset)
